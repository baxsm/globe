...
const Rail: FC = () => {
  ...
  return (
    <nav
      aria-label="Sections"
      className="flex shrink-0 gap-1 border-border border-b bg-surface px-3 py-2 sm:w-52 sm:flex-col sm:gap-0.5 sm:border-r sm:border-b-0 sm:px-3 sm:py-4"
    >
      ...
      {DESTINATIONS.map(({ href, label, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "flex items-center gap-2.5 rounded-sheet px-3 py-2 text-sm transition-colors",
              active
